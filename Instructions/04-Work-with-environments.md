...
Per eseguire notebook e script, è necessario assicurarsi che siano installati i pacchetti necessari. Gli ambienti consentono di specificare i runtime e i pacchetti Python che devono essere usati dal calcolo per eseguire il codice.

In questo esercizio verranno fornite informazioni sugli ambienti e su come usarli durante il training di modelli di Machine Learning con l'ambiente di calcolo di Azure Machine Learning.
