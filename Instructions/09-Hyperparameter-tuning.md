---
lab:
  title: Eseguire l'ottimizzazione degli iperparametri con un processo sweep
---

# Eseguire l'ottimizzazione degli iperparametri con un processo sweep
...
In questo esercizio si userà Azure Machine Learning per ottimizzare gli iperparametri eseguendo più prove di training in parallelo.
