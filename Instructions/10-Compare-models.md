---
lab:
  title: Creare ed esplorare il dashboard di IA responsabile
---

# Creare ed esplorare il dashboard di IA responsabile

Dopo aver eseguito il training del modello, è consigliabile valutare il modello per verificare se è in esecuzione come previsto. Accanto alle metriche delle prestazioni, è possibile prendere in considerazione altri fattori. Il dashboard di intelligenza artificiale responsabile in Azure Machine Learning consente di analizzare i dati e le stime del modello per identificare eventuali distorsioni o ingiustità.
...
Ora che si dispone di tutte le risorse necessarie, è possibile eseguire il notebook per recuperare i componenti di intelligenza artificiale responsabili predefiniti, creare una pipeline e inviare la pipeline per generare un dashboard di intelligenza artificiale responsabile.
