---
lab:
  title: Creare ed esplorare il dashboard di intelligenza artificiale responsabile
---

# Creare ed esplorare il dashboard di intelligenza artificiale responsabile

Dopo aver eseguito il training del modello, si vuole valutare il modello per esplorare se è in esecuzione come previsto. Accanto alle metriche delle prestazioni, esistono altri fattori che è possibile prendere in considerazione. Il dashboard di intelligenza artificiale responsabile in Azure Machine Learning consente di analizzare i dati e le stime del modello per identificare eventuali pregiudizi o ingiustità.
...
## Creare una pipeline per valutare i modelli e inviare da un notebook

Dopo avere tutte le risorse necessarie, è possibile eseguire il notebook per recuperare i componenti di intelligenza artificiale responsabili predefiniti, creare una pipeline e inviare la pipeline per generare un dashboard di intelligenza artificiale responsabile.
