...
1. Assegnare al nuovo file il nome `train-classification-model.py`. 
...
1. Esaminare le proprietà del processo. Si noti che **Command** mostra il valore del parametro di comando del processo di **comando** : il comando eseguito per eseguire lo script.
