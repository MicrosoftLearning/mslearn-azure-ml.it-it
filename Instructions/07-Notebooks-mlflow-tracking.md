...
1. Nella studio di Azure Machine Learning passare alla **pagina Calcolo** e verificare che l'istanza di calcolo creata nella sezione precedente esista. L'istanza di calcolo deve essere in esecuzione.
