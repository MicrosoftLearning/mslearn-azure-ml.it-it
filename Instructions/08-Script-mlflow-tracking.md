...
MLflow è una piattaforma open source per la gestione del ciclo di vita end-to-end di Machine Learning. MLflow Tracking è un componente che registra e tiene traccia delle metriche, dei parametri e degli artefatti modello del processo di training.
...
1. Aprire il notebook **Labs/08/Use MLflow to track jobs.ipynb**.
