...
In questo esercizio si distribuirà un modello MLflow in un endpoint online gestito e lo si testerà sui dati di esempio. 
...
1. Aprire il **notebook Labs/11/Deploy to online endpoint.ipynb (Lab/11/Deploy to online endpoint.ipynb** ).
